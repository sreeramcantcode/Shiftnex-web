...
export default function CoverEveryAngle() {
  ...
  useEffect(() => {
    ...
    blocks.forEach(({ ref }) => {
      ...
      tl.to(chars, { color: "#9a9a9a", ease: "none" });
      tl.to(chars, { color: "#1c1c1c", ease: "none" });
  ...
  return (
    <section ref={sectionRef} className="bg-black">
      <div className="px-4 sm:px-8 py-16 sm:py-24 overflow-hidden">
        <div className="max-w-full mx-auto relative">
          ...
          <div className="w-full max-w-full flex justify-center">
            <p className="text-steel sub text-center text-base sm:text-lg leading-relaxed max-w-5xl">
          ...
          <div className="mt-16 flex relative max-h-full flex-col items-center sm:mt-24">
            <p
              ref={line1Ref}
              className="font-display text-[20vw] sm:text-[14vw] md:text-[15rem] leading-none select-none"
              style={{
                WebkitMaskImage: "linear-gradient(to bottom, black 55%, transparent 100%)",
                maskImage: "linear-gradient(to bottom, black 55%, transparent 100%)",
              }}
            ...
            <p
              ref={line2Ref}
              className="font-display text-[25vw] sm:text-[18vw] md:text-[20rem] leading-none select-none"
              style={{
                WebkitMaskImage: "linear-gradient(to bottom, black 55%, transparent 100%)",
                maskImage: "linear-gradient(to bottom, black 55%, transparent 100%)",
              }}
